...
<body>
    ...
    <div class="container-fluid" style="background-color: #9FFE9F">
        <div class="row mt-2">
            <div class="col-4 mt-3">
                <?xml version="1.0" ?>
                <!DOCTYPE svg PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg
                    style="width: 36px; height: 36px;" enable-background="new 0 0 512 512" id="Layer_1" version="1.1"
                ...
                <br>
                <br>
                <h3>Contactanos a WhatsApp</h3>
                <br>
                <a href="">+569 12345678</a>
            </div>
            <div class="col-4 mt-3">
		...
		C474.946,420.878,480.571,397.035,475.009,380.316z" />
                ...
                <br>
                <br>
                <h3>Contactanos a Telefono</h3>
                <br>
                <a href="">9 87654321</a>
            </div>
            <div class="col-4">
                <img src="https://i0.wp.com/instyle.mx/wp-content/uploads/2020/07/zac-efron.jpg?fit=1280%2C1280&ssl=1"
                    alt="call me bby" style="width:300px; height: 300px;">
            </div>
        </div>
    </div>
