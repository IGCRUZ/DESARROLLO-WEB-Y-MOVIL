            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        <h4 class="card-title">Balon Cuadrado</h4>
                        <p class="card-text">Perfecto para jugar en minecraft</p>
                        <a href="#" class="btn btn-primary mt-auto">$10.000</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100">
                    <img class="card-img-top"
                        src="https://i.pinimg.com/736x/03/d0/4b/03d04b611a7ecafe906ba9a4b77634bc.jpg" alt="Card image"
                        style="width:100%; height:150px">
                    <div class="card-body d-flex flex-column">
                        <h4 class="card-title">Nike Carton Flex 4</h4>
                        <p class="card-text">Zapatos perfecto para la combinacion con el balon cuadrado, nadie te
                            podra parar!</p>
                        <a href="#" class="btn btn-primary mt-auto">$58.990</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100">
                    <img class="card-img-top"
                        ...
                        alt="Card image" style="width:100%; height:150px">
                    <div class="card-body d-flex flex-column">
                        <h4 class="card-title">Guantes chiquitos</h4>
                        <p class="card-text">Al puro estilo de el Friibu Martinez, Con estos guantes no se te pasa
                            ninguna</p>
                        <a href="#" class="btn btn-primary mt-auto">$14.980</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100">
                    <img class="card-img-top"
                        ...
                        alt="Card image" style="width:100%; height:150px">
                    <div class="card-body d-flex flex-column">
                        <h4 class="card-title">Camiseta Aguante el Furbo</h4>
                        <p class="card-text">Con esta camiseta, ni tu novia se podra negar a un furbito</p>
                        <a href="#" class="btn btn-primary mt-auto">$67.670</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check mb-3">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="remember"> Recordar Contraseña
                            </label>
                        </div>
